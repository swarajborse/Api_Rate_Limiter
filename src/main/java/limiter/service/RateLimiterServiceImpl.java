...
public class RateLimiterServiceImpl implements RateLimiterService {
    ...
    public RateLimitResponse checkRateLimit(RateLimitRequest request){
        ...
        ClientConfiguration clientConfiguration=clientConfigurationRepository.findByClientId(request.clientId())
                .orElseThrow(()-> new ClientConfigurationNotFoundException("Configuration not found for client :" +
                        request.clientId()));
